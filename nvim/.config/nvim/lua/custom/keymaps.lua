...
-- netrw split and explore keymaps
vim.keymap.set('n', '<leader>eh', ':Vexplore<CR>', { desc = '[E]xplore split left'})
vim.keymap.set('n', '<leader>el', ':Vexplore!<CR>', { desc = '[E]xplore split right'})
vim.keymap.set('n', '<leader>ej', ':Hexplore<CR>', { desc = '[E]xplore split down'})
vim.keymap.set('n', '<leader>ek', ':Hexplore!<CR>', { desc = '[E]xplore split up'})
vim.keymap.set('n', '<leader>ee', ':Explore<CR>', { desc = '[E]xplore current dir' })
...
-- LspStop
vim.keymap.set('n', '<leader>lx', ':LspStop<CR>', { desc = '[L]sp stop[X]' } )
-- Leet
